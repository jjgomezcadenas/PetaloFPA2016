...
\begin{tcolorbox}[colback=yellow,arc=0pt,outer arc=0pt,colframe=black,boxrule=0.6pt,left=0mm,right=0mm]
  \begin{center}
    AVISO IMPORTANTE\\
  \end{center}
    En virtud del art\'iculo 16 de la convocatoria \ul{\textbf{NO SE ACEPTAR\'AN NI SER\'AN SUBSANABLES MEMORIAS CIENT\'IFICO-T\'ECNICAS}} que no se presenten en este formato.
     \\
    \textbf{La parte C no podrá exceder 20 p\'aginas.}
    \\
    \\
...
\begin{tcolorbox}[colback=yellow,arc=0pt,outer arc=0pt,colframe=black,boxrule=0.6pt,left=0mm]
  \noindent\textbf{Parte C: DOCUMENTO CIENTÍFICO / SCIENTIFIC DOCUMENT: Máximo 20 páginas}
  %\section{RESUMEN DE LA PROPUESTA/SUMMARY OF THE PROPOSAL}
\end{tcolorbox}
...
\input{src/MetodologyDET.tex} 
\input{src/MetodologyASIC.tex}
\input{src/MetodologyIMG.tex} 
...
\input{src/InfraIFIC.tex}
\input{src/InfraUPV.tex}
